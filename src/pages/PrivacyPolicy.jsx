  ...
  return (
    ...
    >
      <Box margin={"0 auto"} mb={2}>
        <Typography variant="h3">개인정보 처리 방침</Typography>
      </Box>
      <Box display={"flex"} gap={2} flexDirection={"column"}>
        ...
        <Typography variant="body2">
          ...
          아래와 같은 개인정보를 수집하고 있습니다. <br /> 수집항목:
          카카오계정(이메일), 닉네임, 카카오톡 채널 추가 상태 및 내역 <br />{" "}
          개인정보 수집방법: 홈페이지(회원 가입)
        </Typography>
        <Typography variant="body2">
          ■ 개인정보의 수집 및 이용목적 회사는 수집한 개인정보를 다음의 목적을
          위해 활용합니다. <br /> 유니음 서비스 내 이용자 식별, 회원관리 및
          서비스 제공 <br />
        </Typography>
        <Typography variant="body2">
        ...
        <Typography variant="body2">
          ...
          방법은 다음과 같습니다. <br />ο 파기절차 회원님이 회원 가입 등을 위해
          입력하신 정보는 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우 별도의
          서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유
          및 이용기간 참조) 일정 기간 저장된 후 파기되어집니다. 별도 DB로 옮겨진
          개인정보는 법률에 의한 경우가 아니고서는 보유되어지는 이외의 다른
          목적으로 이용되지 않습니다.
          <br /> ο 파기방법 - 전자적 파일형태로 저장된 개인정보는 기록을 재생할
        ...
        <Typography variant="body2">
          ...
          <br /> 개인정보관리책임자 성명: 황준걸 <br />
          전화번호: 010-5252-6920 <br />
          이메일: teamapis12@gmail.com
        </Typography>
        <Typography variant="body2">
          ...
          문의하시기 바랍니다.
          <br /> 1. 대검찰청 사이버수사과 (cybercid.spo.go.kr) <br />

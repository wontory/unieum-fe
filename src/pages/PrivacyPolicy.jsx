const PrivacyPolicy = () => {
  return (
    <div className="card bg-base-100 shadow-xl max-w-[1200px] w-full">
      <div className="card-body">
        ...
        <div>
          <ul className="list-inside list-disc">
            <li>
              수집하는 개인정보 항목 회사는 회원 가입, 상담, 서비스 신청 등을
              위해 아래와 같은 개인정보를 수집하고 있습니다.
              <ul className="list-inside list-[square] pl-4">
                <li>
                  수집항목: 카카오계정(이메일), 닉네임, 카카오톡 채널 추가 상태
                  및 내역
                </li>
            ...
            <li>
              ...
              <ul className="list-inside list-[square] pl-4">
                ...
                <li>
                  파기방법 - 전자적 파일형태로 저장된 개인정보는 기록을 재생할
